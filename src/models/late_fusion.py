from models.components.branches import Branches
...
class LateFusionModule(LightningModule):
    ...
    def __init__(
        ...
        self.fusion = fusion
        self.classifier = torch.nn.Linear(self.fusion.out_dim, self.hparams.num_labels)
