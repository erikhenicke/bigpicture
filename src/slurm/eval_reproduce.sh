...
srun uv run --env-file .env src/results/eval_reproduce.py --config src/train/configs/run/feature_fusion.yaml --run-name concat
srun uv run --env-file .env src/results/eval_reproduce.py --config src/train/configs/run/feature_fusion.yaml --run-name film
srun uv run --env-file .env src/results/eval_reproduce.py --config src/train/configs/run/feature_fusion.yaml --run-name geoprior
srun uv run --env-file .env src/results/eval_reproduce.py --config src/train/configs/run/feature_fusion.yaml --run-name d3g
srun uv run --env-file .env src/results/eval_reproduce.py --config src/train/configs/run/feature_fusion.yaml --run-name concat_detach
srun uv run --env-file .env src/results/eval_reproduce.py --config src/train/configs/run/feature_fusion.yaml --run-name d3g_detach_lr
srun uv run --env-file .env src/results/eval_reproduce.py --config src/train/configs/run/feature_fusion.yaml --run-name d3g_detach_hr
srun uv run --env-file .env src/results/eval_reproduce.py --config src/train/configs/run/feature_fusion.yaml --run-name d3g_detach_both
srun uv run --env-file .env src/results/eval_reproduce.py --config src/train/configs/run/feature_fusion.yaml --run-name film_detach
