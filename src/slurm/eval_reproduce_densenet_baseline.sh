...
#SBATCH --job-name=reproduce_densenet_baseline
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem-per-cpu=8GB
#SBATCH --output=log/slurm/reproduce_densenet_baseline.%j.out
#SBATCH --error=log/slurm/reproduce_densenet_baseline.%j.err
